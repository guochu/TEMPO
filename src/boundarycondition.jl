...
# function boundarycondition!(x::ADT, lattice::RealADTLattice1Order; band::Int=1, trunc::TruncationScheme=DefaultIntegrationTruncation)
...
# function boundarycondition!(x::ADT, lattice::MixedADTLattice1Order; band::Int=1, trunc::TruncationScheme=DefaultIntegrationTruncation)

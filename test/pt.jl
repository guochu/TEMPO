println("------------------------------------")
println("|           ProcessTensor          |")
println("------------------------------------")

@testset "ProcessTensor: arithmetic and canonicalize" begin
	L = 6
	D = 6
	tol = 1.0e-7
	for T in (Float64, ComplexF64)
		psi = randompt(T, L, D=D)
...
@testset "ProcessTensor: multiplications" begin
	L = 6
	chi = 20
